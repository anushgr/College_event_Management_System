...
const GlassEventCard = ({ event, role, onDelete, index }) => {
  ...
  return (
    ...
    >
      ...
      <Link
        to={`/events/${event.id}`}
        className="p-6 flex flex-col flex-grow block focus:outline-none"
      ...
      >
        ...
        {/* Title */}
        <h3 className="text-white font-bold text-xl leading-snug mb-3 line-clamp-2 hover:text-indigo-200 transition-colors">
          {event.title}
        </h3>
      ...
      {role === 'ORGANIZER' && (
        <div className="px-6 pb-6">
          <div className="glass-card-divider" style={{ margin: '0 0 12px' }} />
